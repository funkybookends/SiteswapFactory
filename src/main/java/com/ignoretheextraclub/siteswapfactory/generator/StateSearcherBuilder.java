...
/**
 * A builder class for a state searcher. Can be reused with different {@link com.ignoretheextraclub.siteswapfactory.generator.StateSearcher.SiteswapConstructor}s
...
public class StateSearcherBuilder<T extends Siteswap>
{
    ...
    private StateSearcher.SiteswapConstructor<T> siteswapConstructor;
    ...
    public StateSearcherBuilder<T> setSiteswapConstructor(final StateSearcher.SiteswapConstructor<T> siteswapConstructor)
    {
    ...
    /**
     * Constructs a new {@link StateSearcher} using the given {@link com.ignoretheextraclub.siteswapfactory.generator.StateSearcher.SiteswapConstructor}
     *
     * @return A SiteswapGenerator
     */
