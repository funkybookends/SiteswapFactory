...
public class FourHandedPassingStrategyTest
{
    ...
    public void isSameAsExpected() throws Exception
    {
        ...
        {
            final FourHandedSiteswap fourHandedSiteswap = SiteswapFactory.createFHS(constructor);
            softly.assertThat(fourHandedSiteswap.toString())
                  .as("Constructed with: " + constructor)
                  .isEqualTo(expected);
        }
    }

    @Test
    public void isStable() throws Exception
    {
        final FourHandedSiteswap expectedResult = SiteswapFactory.createFHS(expected);
        for (final String constructor : getRotations(expected))
        {
            final FourHandedSiteswap constructed = SiteswapFactory.createFHS(constructor);
            softly.assertThat(constructed.toString())
                  .as("Constructed with: " + constructor)
                  .isEqualTo(expectedResult.toString());
        }
    }

    private String[] getRotations(final String siteswap)
    {
