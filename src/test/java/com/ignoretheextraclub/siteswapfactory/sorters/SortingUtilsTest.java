...
public class SortingUtilsTest
{
    ...
    public void getFirstMinIndex_Object() throws Exception
    {
        Assert.assertEquals(2,
                            SortingUtils.getFirstMinIndex(Arrays.stream(new int[]{5, 5, 3, 7})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(0,
                            SortingUtils.getFirstMinIndex(Arrays.stream(new int[]{3, 7})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(4,
                            SortingUtils.getFirstMinIndex(Arrays.stream(new int[]{5, 5, 3, 7, 1})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(3,
                            SortingUtils.getFirstMinIndex(Arrays.stream(new int[]{5, 8, 5, 3, 3})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
    }
    ...
    {
        Assert.assertEquals(3,
                            SortingUtils.getFirstMaxIndex(Arrays.stream(new int[]{5, 5, 3, 7})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(1,
                            SortingUtils.getFirstMaxIndex(Arrays.stream(new int[]{3, 7})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(3,
                            SortingUtils.getFirstMaxIndex(Arrays.stream(new int[]{5, 5, 3, 7, 1})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
        Assert.assertEquals(1,
                            SortingUtils.getFirstMaxIndex(Arrays.stream(new int[]{5, 8, 5, 3, 3})
                                                                .boxed()
                                                                .collect(Collectors.toList())));
    }
