...
//        final FourHandedSiteswap same = SiteswapFactory.createFHS("867", NoStartingStrategy.get(), true);
...
//        softly.assertThat(vanillaSiteswap.getStartingStrategy()).isEqualTo(FourHandedPassingStrategy.get());
