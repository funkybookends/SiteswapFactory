...
//    {
//        final TwoHandedSiteswap unsorted = SiteswapFactory.createTHS(stringSiteswap, NoStartingStrategy.get(), true);
//        softly.assertThat(unsorted.toString()).as("unsorted toString").isEqualTo(stringSiteswap.toUpperCase());
//        final TwoHandedSiteswap hfsSorted = SiteswapFactory.createTHS(stringSiteswap, HighestThrowFirstStrategy.get(),true);
