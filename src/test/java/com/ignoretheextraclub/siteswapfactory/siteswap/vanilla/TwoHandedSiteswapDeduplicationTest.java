...
//    {
//        final TwoHandedSiteswap fhs = SiteswapFactory.createTHS(stringSiteswap, NoStartingStrategy.get(), true);
...
//    {
//        final TwoHandedSiteswap fhs = SiteswapFactory.createTHS(stringSiteswap, HighestThrowFirstStrategy.get(), true);
//    }
//
//    @Test
//    public void testCreateWithNoSortingStrategyNoReduce() throws Exception
//    {
//        final TwoHandedSiteswap fhs = SiteswapFactory.createTHS(stringSiteswap, NoStartingStrategy.get(), false);
...
//    {
//        final TwoHandedSiteswap fhs = SiteswapFactory.createTHS(stringSiteswap, HighestThrowFirstStrategy.get(), false);
//    }
//
//    @Test
