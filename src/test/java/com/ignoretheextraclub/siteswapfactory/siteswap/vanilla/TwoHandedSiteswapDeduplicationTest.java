...
public class TwoHandedSiteswapDeduplicationTest
{
   ...
   {
       final TwoHandedSiteswap fhs = SiteswapFactory.getTwoHandedSiteswap(new SiteswapRequest(stringSiteswap, true, null, null, NoStartingStrategy.get()));
   ...
   {
       final TwoHandedSiteswap fhs = SiteswapFactory.getTwoHandedSiteswap(new SiteswapRequest(stringSiteswap, true, null, null, HighestThrowFirstStrategy.get()));
   }

   @Test
   public void testCreateWithNoSortingStrategyNoReduce() throws Exception
   {
       final TwoHandedSiteswap fhs = SiteswapFactory.getTwoHandedSiteswap(new SiteswapRequest(stringSiteswap, false, null, null, NoStartingStrategy.get()));
   ...
   {
       final TwoHandedSiteswap fhs = SiteswapFactory.getTwoHandedSiteswap(new SiteswapRequest(stringSiteswap, false, null, null, HighestThrowFirstStrategy.get()));
   }

   @Test
   public void testCreateWithFourHandedPassingStrategy() throws Exception
   {
       SiteswapFactory.getTwoHandedSiteswap(new SiteswapRequest(stringSiteswap, true, null, null, FourHandedPassingStrategy.get()));
   }
}