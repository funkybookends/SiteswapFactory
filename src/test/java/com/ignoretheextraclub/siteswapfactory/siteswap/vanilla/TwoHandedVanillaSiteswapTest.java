...
//    {
//        final TwoHandedSiteswap vanillaSiteswap = SiteswapFactory.createTHS("534");
//        final TwoHandedSiteswap same = SiteswapFactory.createTHS("453", NoStartingStrategy.get(), true);
//        final TwoHandedSiteswap different = SiteswapFactory.createTHS("441");
...
//        softly.assertThat(vanillaSiteswap.getStartingStrategy()).isEqualTo(HighestThrowFirstStrategy.get());
