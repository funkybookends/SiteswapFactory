 ...
 */
public class StatesToFourHandedSiteswapConstructorTest
{
    ...
    public void WHEN_noReduce_noSort_EXPECT_siteswap() throws Exception
    {
        ...
        final FourHandedSiteswap result = StatesToFourHandedSiteswapConstructor.get().apply(siteswapRequest);
    ...
    public void WHEN_reduce_noSort_EXPECT_Reducedsiteswap() throws Exception
    {
        ...
        final FourHandedSiteswap result = StatesToFourHandedSiteswapConstructor.get().apply(siteswapRequest);
        final FourHandedSiteswap expected = new FourHandedSiteswap(new VanillaState[]{XXXXXXX__});
    ...
    {
        Assertions.assertThat(StatesToFourHandedSiteswapConstructor.get().accepts(new State[]{})).isTrue();
        Assertions.assertThat(StatesToFourHandedSiteswapConstructor.get().accepts(new VanillaState[]{})).isTrue();
        Assertions.assertThat(StatesToFourHandedSiteswapConstructor.get().accepts(null)).isFalse();
        Assertions.assertThat(StatesToFourHandedSiteswapConstructor.get().accepts(XXX__)).isFalse();
        Assertions.assertThat(StatesToFourHandedSiteswapConstructor.get().accepts("sdfdf")).isFalse();
    }
}