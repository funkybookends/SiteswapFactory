...
//    {
//        assertThat(new SimpleReducer<String>().reduce(input)).isEqualTo(expected);
//        assertThat(SimpleReducer.reduce(input)).isEqualTo(expected);
//        assertThat(SimpleReducer.getReducerFor(input).apply(input)).isEqualTo(expected);
//    }
//
...
//    {
//        assertThat(SimpleReducer.IntReducer.get().apply(input)).isEqualTo(expected);
//        assertThat(SimpleReducer.reduce(input)).isEqualTo(expected);
//    }
//
...
//    {
//        assertThatThrownBy(() -> SimpleReducer.reduce(input)).isInstanceOf(exception.getClass())
