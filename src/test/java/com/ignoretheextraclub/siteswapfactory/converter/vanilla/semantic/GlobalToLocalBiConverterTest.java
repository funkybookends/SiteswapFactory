...
public class GlobalToLocalBiConverterTest
{
    ...
    {
        assertThatThrownBy(() -> new GlobalToLocalBiConverter<VanillaThro>().apply(input, start))
            .isInstanceOf(exception.getClass())
            .hasMessageContaining(exception.getMessage());
        assertThatThrownBy(() -> GlobalToLocalBiConverter.convertToLocal(input, start))
            .isInstanceOf(exception.getClass())
            .hasMessageContaining(exception.getMessage());
    }
    ...
    public void testExceptionInt(final int[] input,
                                 ...
                                 final Exception exception) throws Exception
    {
        assertThatThrownBy(() -> GlobalToLocalBiConverter.IntConverter.get().apply(input, start))
            .isInstanceOf(exception.getClass())
            .hasMessageContaining(exception.getMessage());
        assertThatThrownBy(() -> GlobalToLocalBiConverter.convertToLocal(input, start))
            .isInstanceOf(exception.getClass())
